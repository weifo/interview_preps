...
def generate_verify_image(size=(120, 30),
    ...
    # img.save('./files',img_type)

    if save_img:
        img.save("./files/validate.gif", img_type)

    return  strs


if __name__ == "__main__":
    strs = generate_verify_image(save_img=True)
    print(strs)
